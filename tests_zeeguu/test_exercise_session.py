...
class UserExerciseSessionTest(ModelTestMixIn, TestCase):
    ...
    def test__find_by_user_only_one_active(self):
        ...
        active_sessions = UserExerciseSession.find_by_user(user.id, self.VERY_FAR_IN_THE_PAST,
    ...
    def test__find_by_cohort(self):
        ...
        active_sessions = UserExerciseSession.find_by_cohort(cohort_id, self.VERY_FAR_IN_THE_PAST,
                                                             self.VERY_FAR_IN_THE_FUTURE,
                                                             is_active=True)
